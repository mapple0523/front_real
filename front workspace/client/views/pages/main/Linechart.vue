...
export default {
  ...
  //     var canvas = chartInstance.value.ctx.canvas;
  //     var url = canvas.toDataURL('image/png');

  //     try {
  //       const response = await $axios.post('/upload-image', { image: url });
  ...
  //   return { chartInstance, saveChartAsImage };
  // },
  methods: {
    createChart() {
